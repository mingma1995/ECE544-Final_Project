...
## to the top level n4fpga.v provided with ECE 544 Final Project
## Modified by Ming Ma 6/11/2019
##
...
#set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS33 } [get_ports { LED[0] }]; #IO_L16N_T2_A27_15 Sch=ja[7]
...
#set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { LED[1] }]; #IO_L15P_T2_DQS_35 Sch=jd[7]
